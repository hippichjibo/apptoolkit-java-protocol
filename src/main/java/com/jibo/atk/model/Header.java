...
*/
 abstract public class Header {
     ...
     /**
      * @return session id - The id for the session of which this message belongs to
      */
     ...
     /**
      * @return transaction id - The id for which this message is a part of.  
      * Each Request Message will have a corresponding Response Message which will share the same transaction id.
      */
     ...
     static public class RequestHeader extends Header {
          ...
          * @param transactionID A unique Id which the client comes up with to distinguish send / receive command transaction from other commands within the session
          * @param sessionID The Id which is included in the response to the SessionRequest Command. This Id is generated by the robot and is used to distinguish a particular
          * command transaction session from a given client.  The same sessionId should be supplied if the client is unexectedly disconnected from the robot and you wish to
          * re-establish the prior session.
          * @param version The version of the protocol this Command will speak. Refer to Header.RequestHeader.VER_1 for an example of valid values for this parameter.  
          * Supplying a Command from a different protocol version will result in a rejected Command from the robot.
          */
     ...
     static public class ResponseHeader extends Header {
        ...
        /**
          ...
          * This will be in the format of Color-Concept-Food-Material
          */
